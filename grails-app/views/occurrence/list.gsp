            ...
            <div class="col-sm-9 col-md-9">
                ...
                <g:if test="${grailsApplication.config.useDownloadPlugin?.toBoolean()}">
                    <div id="downloads" class="btn btn-primary pull-right">
                        <alatag:download searchResults="${sr}" qualityCategories="${qualityCategories}" class="tooltips newDownload" title="Download all ${g.formatNumber(number: sr.totalRecords, format: "#,###,###")} records">
