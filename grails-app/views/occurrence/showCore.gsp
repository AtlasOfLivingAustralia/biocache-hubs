...
<g:set var="useAla" value="${grailsApplication.config.getProperty('skin.useAlaBie', Boolean ? 'true' : 'false')}"/>
<g:set var="taxaLinks" value="${grailsApplication.config.getProperty('skin.taxaLinks')}"/>
<g:set var="hubDisplayName" value="${grailsApplication.config.getProperty('site.displayName')}"/>
