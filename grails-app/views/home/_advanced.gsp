...
<form class="form-horizontal" name="advancedSearchForm" id="advancedSearchForm" action="${request.contextPath}/advancedSearch" method="POST">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="text"><g:message code="advancedsearch.table01col01.title" default="ALL of these words (full text)"/></label>
        <div class="col-sm-4">
    ...
    <g:each in="${1..4}" var="i">
        ...
        <div class="form-group" id="taxon_row_${i}">
            <label class="col-sm-2 control-label" for="taxa_${i}"><g:message code="advancedsearch.table02col01.title" default="Species/Taxon"/></label>
            <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="raw_taxon_name"><g:message code="advancedsearch.table03col01.title" default="Raw Scientific Name"/></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="species_group"><g:message code="advancedsearch.table04col01.title" default="Species Group"/></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="institution_collection"><g:message code="advancedsearch.table05col01.title" default="Institution or Collection"/></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="country"><g:message code="advancedsearch.table06col01.title" default="Country"/></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="state"><g:message code="advancedsearch.table06col02.title" default="State/Territory"/></label>
        <div class="col-sm-4">
    ...
    <g:if test="${request.getAttribute("cl1048") && request.getAttribute("cl1048").size() > 1}">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="ibra"><abbr title="Interim Biogeographic Regionalisation of Australia">IBRA</abbr> <g:message code="advancedsearch.table06col03.title" default="region"/></label>
            <div class="col-sm-4">
    ...
    <g:if test="${request.getAttribute("cl21") && request.getAttribute("cl21").size() > 1}">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="imcra"><abbr title="Integrated Marine and Coastal Regionalisation of Australia">IMCRA</abbr> <g:message code="advancedsearch.table06col04.title" default="region"/></label>
            <div class="col-sm-4">
    ...
    <g:if test="${request.getAttribute("cl959") && request.getAttribute("cl959").size() > 1}">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="lga"><g:message code="advancedsearch.table06col05.title" default="Local Govt. Area"/></label>
            <div class="col-sm-4">
    ...
    <g:if test="${request.getAttribute("type_status") && request.getAttribute("type_status").size() > 1}">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="type_status"><g:message code="advancedsearch.table07col01.title" default="Type Status"/></label>
            <div class="col-sm-4">
    ...
    <g:if test="${request.getAttribute("basis_of_record") && request.getAttribute("basis_of_record").size() > 1}">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="basis_of_record"><g:message code="advancedsearch.table08col01.title" default="Basis of record"/></label>
            <div class="col-sm-4">
    ...
    <g:if test="${request.getAttribute("data_resource_uid") && request.getAttribute("data_resource_uid").size() > 1}">
        <div class="form-group">
            %{--for="dataset"--}%
            <label class="control-label col-sm-2" ><g:message code="advancedsearch.dataset.col.label" default="dataset name"/></label>
            <div class="col-sm-4">
                <select class="dataset bscombobox form-control" name="dataset" id="dataset">
                    <option value=""></option>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="catalogue_number"><g:message code="advancedsearch.table09col01.title" default="Catalogue Number"/></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="record_number"><g:message code="advancedsearch.table09col02.title" default="Record Number"/></label>
        <div class="col-sm-4">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="startDate"><g:message code="advancedsearch.table10col01.title" default="Begin Date"/></label>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label" for="endDate"><g:message code="advancedsearch.table10col02.title" default="End Date"/></label>
        <div class="col-sm-2 control-label">
