...
## Getting started
The easiest way to get started is to clone the **generic-hub** project and then modify to suit your needs. Any functionality that you wish to alter is achieved by creating a copy of the groovy/GSP/JS/CSS/i18n file from **biocache-hubs** and placing it in your calling app, so that it overrides the plugin version. 
...
The default configuration settings are found in `grails-app/conf/defaultConfig.groovy`.
